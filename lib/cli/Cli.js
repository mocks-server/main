...
const Server = require("../core/Server"); // TODO, remove dependency
const tracer = require("../core/tracer"); // TODO, remove dependency
...
class Cli {
  constructor(options, quitMethod) {
    ...
    this._cli = new Inquirer(this._questions, this.header.bind(this), quitMethod);
    this._server = new Server(this._options.behaviors, this._options);
  ...
  header() {
    const header = [
      ...
      `Current fixtures: ${chalk.cyan(this._behaviors.currentTotalFixtures)}`,
