...
class Cli {
  constructor(options, quitMethod) {
    ...
    // TODO, deprecate features option compatibility
    this._cli = new inquirer.Inquirer(this._questions, this.header.bind(this), quitMethod);
    this._server = new Server(this._options.behaviors || this._options.features, this._options);
