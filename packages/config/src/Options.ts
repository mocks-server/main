...
export const FILE_SEARCH_PLACES_OPTION: OptionName = "fileSearchPlaces";
export const FILE_SEARCH_FROM_OPTION: OptionName = "fileSearchFrom";
export const FILE_SEARCH_STOP_OPTION: OptionName = "fileSearchStop";
export const ALLOW_UNKNOWN_ARGUMENTS_OPTION: OptionName = "allowUnknownArguments";
