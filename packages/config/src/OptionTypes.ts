...
export type OptionExtraData = AnyObject;
...
export interface BaseOptionProperties extends ObjectWithName {
  ...
  /** Type of the items in the value array when option type is array {@link OptionItemsType} */
...
export type OptionProperties =
  | OptionBooleanProperties
  | OptionNumberProperties
  | OptionStringProperties
  | OptionObjectProperties
  | OptionArrayProperties
  | OptionNullProperties;
