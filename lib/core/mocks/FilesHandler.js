...
class FilesHandler {
  ...
  _loadFiles() {
    ...
    tracer.debug(`Loading behaviors from folder ${this._path}`);
  ...
  get _cache() {
    return this._customRequireCache || require.requireCache;
  }
